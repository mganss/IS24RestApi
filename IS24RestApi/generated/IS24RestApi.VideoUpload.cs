...
namespace IS24RestApi.VideoUpload
{
    ...
    ///                sind. Das Hochladen erfolgt auf API-Client-Seite.</para>
    /// <para xml:lang="en">Information needed for uploading of a video file. Uploading the
    ///                video file is done by API-clients.</para>
    /// </summary>
    ...
    public partial class VideoUploadTicket
    {
        ...
        ///                        "videofile" with the video file, the other is "auth", the authentication-token.</para>
        /// </summary>
        ...
        ///                        mit dem Wert dieses Elements befüllt. Nur zeitweilig gültig, siehe "validUntil".</para>
        /// <para xml:lang="en">When uploading the part named "auth" has to be filled
        ///                        with the value of this element. Only temporarily valid, see "validUntil".</para>
        /// </summary>
        [System.Xml.Serialization.XmlElementAttribute("auth", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
